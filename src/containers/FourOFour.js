...
export default function FourOFour(props) {
    ...
    return (
        <div className="text-center mt-12 lg:mt-40">
            ...
            <Link className="block p-2 w-40 mx-auto mt-8 bg-brand rounded-lg shadow-lg text-white uppercase tracking-normal hover:shadow-2xl hover:bg-blue-600" to="/">Go Home</Link>
        </div>
    );
}